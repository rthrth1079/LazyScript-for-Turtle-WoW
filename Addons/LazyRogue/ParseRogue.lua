...
function lazyRogueLoad.LoadParseRogue()
	...
	lazyRogue.actions.envenom          = lazyRogue.Action:New("envenom",          "INV_Sword_31")
	...
	lazyRogue.actions.noxiousAssault   = lazyRogue.Action:New("noxiousAssault",   "spell_double_dose_3")
